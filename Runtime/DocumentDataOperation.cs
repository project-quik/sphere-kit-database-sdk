...
namespace SphereKit
{
    public class DocumentDataOperation
    {
        ...
        {
            return onInsert ? new DocumentDataOperation(DocumentDataOperationType.SetOnInsert, value) : new DocumentDataOperation(DocumentDataOperationType.Set, value);
        }
        ...
        public static DocumentDataOperation AddMany(object[] values, int? position = null, int? slice = null, object? sort = null)
        {
            ...
            if (sort != null)
            {
                ...
                {  
                    throw new ArgumentException("Sort must be an integer (1 or -1) or a dictionary with one key-value pair (key: string, value: 1 | -1).");
                }
